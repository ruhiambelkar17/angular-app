...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,HttpClientModule,MatMenuModule, MatCardModule,MatButtonModule, MatSelectModule, MatInputModule, MatFormFieldModule, FormsModule, ReactiveFormsModule ],
...
export class EmployeeDashboardComponent implements OnInit {
  ...
  addPost() {
    ...
    const newPost = {data: { empId: 1002, empName:'Emp2', empEmail: 'emp2@gmail.com' }};
  ...
  updatePost(post: any) {
    console.log("update hitted****",post)
